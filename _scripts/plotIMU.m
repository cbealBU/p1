...
subplot(3,2,1)
accelX = uint8todouble(1,0,rt_IMU(:,1),rt_IMU(:,2));
plot(rt_tout,accelX)
...
subplot(3,2,2)
rotRateX = uint8todouble(1,0,rt_IMU(:,7),rt_IMU(:,8));
...
subplot(3,2,3)
accelY = uint8todouble(1,0,rt_IMU(:,3),rt_IMU(:,4));
plot(rt_tout,accelY)
...
subplot(3,2,4)
rotRateY = uint8todouble(1,0,rt_IMU(:,9),rt_IMU(:,10));
...
subplot(3,2,5)
accelZ = uint8todouble(1,0,rt_IMU(:,5),rt_IMU(:,6));
plot(rt_tout,accelZ)
...
% Rotation Rate Z (Yaw)
subplot(3,2,6)
rotRateZ = uint8todouble(1,0,rt_IMU(:,11),rt_IMU(:,12));
plot(rt_tout,accelZ)

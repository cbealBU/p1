...
% creates a new one.
if ~exist('handleWFTLeftFig','var') || 0 == isvalid(handleWFTRightFig)
    handleWFTLeftFig = figure('Name','Wheel Force Transducer (Left)','NumberTitle','off','WindowStyle','docked');
else
...
% creates a new one.
if ~exist('handleWFTRightFig','var') || 0 == isvalid(handleWFTRightFig)
    handleWFTRightFig = figure('Name','Wheel Force Transducer (Right)','NumberTitle','off','WindowStyle','docked');
else

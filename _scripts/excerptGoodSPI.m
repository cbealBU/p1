...
for jj = 1:length(rt_tout)
    cond1 = all(rt_spiBytesIn(jj,1:5) == uint8([115 116 97 114 116]));
    cond2 = all(rt_spiBytesIn(jj,end-2:end) == uint8([101 110 100]));
    if cond1 && cond2
...
clear cond1 cond2 badIndCount goodIndCount jj

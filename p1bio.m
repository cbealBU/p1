...
bio(144).blkName='Sensor Data and Estimation/Steering Kinematics/Steering Angle Calculation/R2D';
bio(144).sigName='';
bio(144).portIdx=0;
bio(144).dim=[2,1];
bio(144).sigWidth=2;
bio(144).sigAddress='&p1_B.R2D[0]';
bio(144).ndims=2;
bio(144).size=[];
...
bio(147).dim=[1,1];
bio(147).sigWidth=1;
bio(147).sigAddress='&p1_B.Gain_a4';
bio(147).ndims=2;
bio(147).size=[];
...
bio(158).blkName='User Controllers/Steering Controller/HAL-9000/Clock';
bio(158).sigName='';
bio(158).portIdx=0;
bio(158).dim=[1,1];
bio(158).sigWidth=1;
bio(158).sigAddress='&p1_B.Clock';
bio(158).ndims=2;
bio(158).size=[];


bio(159).blkName='User Controllers/Steering Controller/HAL-9000/Product';
bio(159).sigName='';
bio(159).portIdx=0;
bio(159).dim=[1,1];
bio(159).sigWidth=1;
bio(159).sigAddress='&p1_B.Product_k';
bio(159).ndims=2;
bio(159).size=[];


bio(160).blkName='User Controllers/Steering Controller/HAL-9000/Product1';
bio(160).sigName='';
bio(160).portIdx=0;
bio(160).dim=[1,1];
bio(160).sigWidth=1;
bio(160).sigAddress='&p1_B.Product1';
bio(160).ndims=2;
bio(160).size=[];


bio(161).blkName='User Controllers/Steering Controller/HAL-9000/Sum';
bio(161).sigName='';
bio(161).portIdx=0;
bio(161).dim=[1,1];
bio(161).sigWidth=1;
bio(161).sigAddress='&p1_B.Sum_hm';
bio(161).ndims=2;
bio(161).size=[];


bio(162).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Encoder Initialization/Encoder Initializer';
bio(162).sigName='';
bio(162).portIdx=0;
bio(162).dim=[1,1];
bio(162).sigWidth=1;
bio(162).sigAddress='&p1_B.EncoderInitializer';
bio(162).ndims=2;
bio(162).size=[];


bio(163).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Encoder Initialization/Unwrapper';
bio(163).sigName='';
bio(163).portIdx=0;
bio(163).dim=[1,1];
bio(163).sigWidth=1;
bio(163).sigAddress='&p1_B.Unwrapper';
bio(163).ndims=2;
bio(163).size=[];


bio(164).blkName='Hardware I//O/Input/Rear Wheel Speed Processing/Speed Calc/Unwrapping';
bio(164).sigName='';
bio(164).portIdx=0;
bio(164).dim=[1,1];
bio(164).sigWidth=1;
bio(164).sigAddress='&p1_B.Unwrapping';
bio(164).ndims=2;
bio(164).size=[];


bio(165).blkName='Hardware I//O/Input/Rear Wheel Speed Processing/Speed Calc1/Unwrapping';
bio(165).sigName='';
bio(165).portIdx=0;
bio(165).dim=[1,1];
bio(165).sigWidth=1;
bio(165).sigAddress='&p1_B.Unwrapping_o';
bio(165).ndims=2;
bio(165).size=[];


bio(166).blkName='Hardware I//O/Input/Steering Motor Encoder Initialization/Left/Encoder Initializer';
bio(166).sigName='';
bio(166).portIdx=0;
bio(166).dim=[1,1];
bio(166).sigWidth=1;
bio(166).sigAddress='&p1_B.EncoderInitializer_c';
bio(166).ndims=2;
bio(166).size=[];


bio(167).blkName='Hardware I//O/Input/Steering Motor Encoder Initialization/Left/Unwrapper';
bio(167).sigName='';
bio(167).portIdx=0;
bio(167).dim=[1,1];
bio(167).sigWidth=1;
bio(167).sigAddress='&p1_B.Unwrapper_o';
bio(167).ndims=2;
bio(167).size=[];


bio(168).blkName='Hardware I//O/Input/Steering Motor Encoder Initialization/Right/Encoder Initializer';
bio(168).sigName='';
bio(168).portIdx=0;
bio(168).dim=[1,1];
bio(168).sigWidth=1;
bio(168).sigAddress='&p1_B.EncoderInitializer_h';
bio(168).ndims=2;
bio(168).size=[];


bio(169).blkName='Hardware I//O/Input/Steering Motor Encoder Initialization/Right/Unwrapper';
bio(169).sigName='';
bio(169).portIdx=0;
bio(169).dim=[1,1];
bio(169).sigWidth=1;
bio(169).sigAddress='&p1_B.Unwrapper_b';
bio(169).ndims=2;
bio(169).size=[];


bio(170).blkName='Hardware I//O/Input/VS330 GPS Data/Subsystem/Math Function2';
bio(170).sigName='';
bio(170).portIdx=0;
bio(170).dim=[1,1];
bio(170).sigWidth=1;
bio(170).sigAddress='&p1_B.MathFunction2';
bio(170).ndims=2;
bio(170).size=[];


bio(171).blkName='Hardware I//O/Input/VS330 GPS Data/Subsystem/Divide1';
bio(171).sigName='';
bio(171).portIdx=0;
bio(171).dim=[1,1];
bio(171).sigWidth=1;
bio(171).sigAddress='&p1_B.Divide1';
bio(171).ndims=2;
bio(171).size=[];


bio(172).blkName='Hardware I//O/Input/VS330 GPS Data/Subsystem/Product';
bio(172).sigName='';
bio(172).portIdx=0;
bio(172).dim=[1,1];
bio(172).sigWidth=1;
bio(172).sigAddress='&p1_B.Product';
bio(172).ndims=2;
bio(172).size=[];


bio(173).blkName='Hardware I//O/Input/VS330 GPS Data/Subsystem/Product4';
bio(173).sigName='';
bio(173).portIdx=0;
bio(173).dim=[1,1];
bio(173).sigWidth=1;
bio(173).sigAddress='&p1_B.Product4';
bio(173).ndims=2;
bio(173).size=[];


bio(174).blkName='Hardware I//O/Input/VS330 GPS Data/Subsystem/Product5';
bio(174).sigName='';
bio(174).portIdx=0;
bio(174).dim=[1,1];
bio(174).sigWidth=1;
bio(174).sigAddress='&p1_B.Product5';
bio(174).ndims=2;
bio(174).size=[];


bio(175).blkName='Sensor Data and Estimation/Nonlinear Observer/Steering Torque Components/Steering Geometry Calculation/Left Steer Angle Look-up1';
bio(175).sigName='Left';
bio(175).portIdx=0;
bio(175).dim=[1,1];
bio(175).sigWidth=1;
bio(175).sigAddress='&p1_B.Left_j';
bio(175).ndims=2;
bio(175).size=[];


bio(176).blkName='Sensor Data and Estimation/Nonlinear Observer/Steering Torque Components/Steering Geometry Calculation/Right Steer Angle Look-up1';
bio(176).sigName='Right';
bio(176).portIdx=0;
bio(176).dim=[1,1];
bio(176).sigWidth=1;
bio(176).sigAddress='&p1_B.Right_h0';
bio(176).ndims=2;
bio(176).size=[];


bio(177).blkName='Sensor Data and Estimation/Nonlinear Observer/Steering Torque Components/Wheel Accelerations/Diff';
bio(177).sigName='';
bio(177).portIdx=0;
bio(177).dim=[1,1];
bio(177).sigWidth=1;
bio(177).sigAddress='&p1_B.Diff';
bio(177).ndims=2;
bio(177).size=[];


bio(178).blkName='Sensor Data and Estimation/Nonlinear Observer/Steering Torque Components/Wheel Accelerations/TSamp';
bio(178).sigName='';
bio(178).portIdx=0;
bio(178).dim=[1,1];
bio(178).sigWidth=1;
bio(178).sigAddress='&p1_B.TSamp';
bio(178).ndims=2;
bio(178).size=[];


bio(179).blkName='Sensor Data and Estimation/Nonlinear Observer/Steering Torque Components/Wheel Accelerations1/Diff';
bio(179).sigName='';
bio(179).portIdx=0;
bio(179).dim=[1,1];
bio(179).sigWidth=1;
bio(179).sigAddress='&p1_B.Diff_b';
bio(179).ndims=2;
bio(179).size=[];


bio(180).blkName='Sensor Data and Estimation/Nonlinear Observer/Steering Torque Components/Wheel Accelerations1/TSamp';
bio(180).sigName='';
bio(180).portIdx=0;
bio(180).dim=[1,1];
bio(180).sigWidth=1;
bio(180).sigAddress='&p1_B.TSamp_i';
bio(180).ndims=2;
bio(180).size=[];


bio(181).blkName='Sensor Data and Estimation/Nonlinear Observer/Steering Torque Components/Wheel Velocities/Diff';
bio(181).sigName='';
bio(181).portIdx=0;
bio(181).dim=[1,1];
bio(181).sigWidth=1;
bio(181).sigAddress='&p1_B.Diff_o';
bio(181).ndims=2;
bio(181).size=[];


bio(182).blkName='Sensor Data and Estimation/Nonlinear Observer/Steering Torque Components/Wheel Velocities/TSamp';
bio(182).sigName='';
bio(182).portIdx=0;
bio(182).dim=[1,1];
bio(182).sigWidth=1;
bio(182).sigAddress='&p1_B.TSamp_a';
bio(182).ndims=2;
bio(182).size=[];


bio(183).blkName='Sensor Data and Estimation/Nonlinear Observer/Steering Torque Components/Wheel Velocities1/Diff';
bio(183).sigName='';
bio(183).portIdx=0;
bio(183).dim=[1,1];
bio(183).sigWidth=1;
bio(183).sigAddress='&p1_B.Diff_ok';
bio(183).ndims=2;
bio(183).size=[];


bio(184).blkName='Sensor Data and Estimation/Nonlinear Observer/Steering Torque Components/Wheel Velocities1/TSamp';
bio(184).sigName='';
bio(184).portIdx=0;
bio(184).dim=[1,1];
bio(184).sigWidth=1;
bio(184).sigAddress='&p1_B.TSamp_h';
bio(184).ndims=2;
bio(184).size=[];


bio(185).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/Gain';
bio(185).sigName='';
bio(185).portIdx=0;
bio(185).dim=[1,1];
bio(185).sigWidth=1;
bio(185).sigAddress='&p1_B.Gain_h';
bio(185).ndims=2;
bio(185).size=[];


bio(186).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/Position Filter';
bio(186).sigName='';
bio(186).portIdx=0;
bio(186).dim=[42,1];
bio(186).sigWidth=42;
bio(186).sigAddress='&p1_B.PositionFilter[0]';
bio(186).ndims=2;
bio(186).size=[];


bio(187).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/Super Filter!';
bio(187).sigName='';
bio(187).portIdx=0;
bio(187).dim=[44,1];
bio(187).sigWidth=44;
bio(187).sigAddress='&p1_B.SuperFilter[0]';
bio(187).ndims=2;
bio(187).size=[];


bio(188).blkName='User Controllers/Cruise Control/Enable Logic/Delay/Unit Delay';
bio(188).sigName='';
bio(188).portIdx=0;
bio(188).dim=[1,1];
bio(188).sigWidth=1;
bio(188).sigAddress='&p1_B.UnitDelay';
bio(188).ndims=2;
bio(188).size=[];


bio(189).blkName='User Controllers/Cruise Control/Enable Logic/Delay/Unit Delay1';
bio(189).sigName='';
bio(189).portIdx=0;
bio(189).dim=[1,1];
bio(189).sigWidth=1;
bio(189).sigAddress='&p1_B.UnitDelay1';
bio(189).ndims=2;
bio(189).size=[];


bio(190).blkName='User Controllers/Cruise Control/Enable Logic/Delay/Unit Delay2';
bio(190).sigName='';
bio(190).portIdx=0;
bio(190).dim=[1,1];
bio(190).sigWidth=1;
bio(190).sigAddress='&p1_B.UnitDelay2';
bio(190).ndims=2;
bio(190).size=[];


bio(191).blkName='User Controllers/Cruise Control/Enable Logic/Delay/Unit Delay3';
bio(191).sigName='';
bio(191).portIdx=0;
bio(191).dim=[1,1];
bio(191).sigWidth=1;
bio(191).sigAddress='&p1_B.UnitDelay3';
bio(191).ndims=2;
bio(191).size=[];


bio(192).blkName='User Controllers/Cruise Control/Enable Logic/Latch1/In1';
bio(192).sigName='';
bio(192).portIdx=0;
bio(192).dim=[1,1];
bio(192).sigWidth=1;
bio(192).sigAddress='&p1_B.Latch1.In1';
bio(192).ndims=2;
bio(192).size=[];


bio(193).blkName='User Controllers/Steering Controller/HAL-9000/Chirp Signal/Gain';
bio(193).sigName='';
bio(193).portIdx=0;
bio(193).dim=[1,1];
bio(193).sigWidth=1;
bio(193).sigAddress='&p1_B.Gain';
bio(193).ndims=2;
bio(193).size=[];


bio(194).blkName='User Controllers/Steering Controller/HAL-9000/Double chirp/Sum';
bio(194).sigName='';
bio(194).portIdx=0;
bio(194).dim=[1,1];
bio(194).sigWidth=1;
bio(194).sigAddress='&p1_B.Sum_d';
bio(194).ndims=2;
bio(194).size=[];


bio(195).blkName='User Controllers/Steering Controller/HAL-9000/Latch/In1';
bio(195).sigName='';
bio(195).portIdx=0;
bio(195).dim=[1,1];
bio(195).sigWidth=1;
bio(195).sigAddress='&p1_B.In1';
bio(195).ndims=2;
bio(195).size=[];


bio(196).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Handwheel Sensor Fault Detection/Descision Logic/Logical Operator';
bio(196).sigName='';
bio(196).portIdx=0;
bio(196).dim=[1,1];
bio(196).sigWidth=1;
bio(196).sigAddress='&p1_B.LogicalOperator';
bio(196).ndims=2;
bio(196).size=[];


bio(197).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Handwheel Sensor Fault Detection/Descision Logic/Logical Operator3';
bio(197).sigName='';
bio(197).portIdx=0;
bio(197).dim=[1,1];
bio(197).sigWidth=1;
bio(197).sigAddress='&p1_B.LogicalOperator3';
bio(197).ndims=2;
bio(197).size=[];


bio(198).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Handwheel Sensor Fault Detection/Descision Logic/Logical Operator4';
bio(198).sigName='';
bio(198).portIdx=0;
bio(198).dim=[1,1];
bio(198).sigWidth=1;
bio(198).sigAddress='&p1_B.LogicalOperator4';
bio(198).ndims=2;
bio(198).size=[];


bio(199).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Handwheel Sensor Fault Detection/Descision Logic/Logical Operator6';
bio(199).sigName='';
bio(199).portIdx=0;
bio(199).dim=[1,1];
bio(199).sigWidth=1;
bio(199).sigAddress='&p1_B.LogicalOperator6';
bio(199).ndims=2;
bio(199).size=[];


bio(200).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Handwheel Sensor Fault Detection/Descision Logic/Memory3';
bio(200).sigName='';
bio(200).portIdx=0;
bio(200).dim=[1,1];
bio(200).sigWidth=1;
bio(200).sigAddress='&p1_B.Memory3';
bio(200).ndims=2;
bio(200).size=[];


bio(201).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Handwheel Sensor Fault Detection/Enable Timer/Relational Operator';
bio(201).sigName='';
bio(201).portIdx=0;
bio(201).dim=[1,1];
bio(201).sigWidth=1;
bio(201).sigAddress='&p1_B.RelationalOperator';
bio(201).ndims=2;
bio(201).size=[];


bio(202).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Handwheel Sensor Fault Detection/Fault Detection1/Memory2';
bio(202).sigName='';
bio(202).portIdx=0;
bio(202).dim=[1,1];
bio(202).sigWidth=1;
bio(202).sigAddress='&p1_B.Memory2';
bio(202).ndims=2;
bio(202).size=[];


bio(203).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Handwheel Sensor Fault Detection/Switch Over/Logical Operator5';
bio(203).sigName='';
bio(203).portIdx=0;
bio(203).dim=[1,1];
bio(203).sigWidth=1;
bio(203).sigAddress='&p1_B.LogicalOperator5';
bio(203).ndims=2;
bio(203).size=[];


bio(204).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Handwheel Sensor Fault Detection/Switch Over/Switch';
bio(204).sigName='';
bio(204).portIdx=0;
bio(204).dim=[1,1];
bio(204).sigWidth=1;
bio(204).sigAddress='&p1_B.Switch';
bio(204).ndims=2;
bio(204).size=[];


bio(205).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/Accelerometer Pre-Processing/cross coupling from ax';
bio(205).sigName='';
bio(205).portIdx=0;
bio(205).dim=[1,1];
bio(205).sigWidth=1;
bio(205).sigAddress='&p1_B.crosscouplingfromax';
bio(205).ndims=2;
bio(205).size=[];


bio(206).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/Accelerometer Pre-Processing/Sum4';
bio(206).sigName='';
bio(206).portIdx=0;
bio(206).dim=[1,1];
bio(206).sigWidth=1;
bio(206).sigAddress='&p1_B.Sum4';
bio(206).ndims=2;
bio(206).size=[];


bio(207).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/Accelerometer Pre-Processing/Sum5';
bio(207).sigName='';
bio(207).portIdx=0;
bio(207).dim=[1,1];
bio(207).sigWidth=1;
bio(207).sigAddress='&p1_B.Sum5_p';
bio(207).ndims=2;
bio(207).size=[];


bio(208).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/GPS Pre-Processing/obsolete1';
bio(208).sigName='';
bio(208).portIdx=0;
bio(208).dim=[1,1];
bio(208).sigWidth=1;
bio(208).sigAddress='&p1_B.obsolete1';
bio(208).ndims=2;
bio(208).size=[];


bio(209).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/GPS Pre-Processing/obsolete2';
bio(209).sigName='';
bio(209).portIdx=0;
bio(209).dim=[1,1];
bio(209).sigWidth=1;
bio(209).sigAddress='&p1_B.obsolete2';
bio(209).ndims=2;
bio(209).size=[];


bio(210).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/GPS Pre-Processing/Data Type Conversion';
bio(210).sigName='';
bio(210).portIdx=0;
bio(210).dim=[1,1];
bio(210).sigWidth=1;
bio(210).sigAddress='&p1_B.DataTypeConversion';
bio(210).ndims=2;
bio(210).size=[];


bio(211).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/GPS Pre-Processing/Gain';
bio(211).sigName='';
bio(211).portIdx=0;
bio(211).dim=[1,1];
bio(211).sigWidth=1;
bio(211).sigAddress='&p1_B.Gain_a';
bio(211).ndims=2;
bio(211).size=[];


bio(212).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/GPS Pre-Processing/Delay function/p1';
bio(212).sigName='';
bio(212).portIdx=0;
bio(212).dim=[1,1];
bio(212).sigWidth=1;
bio(212).sigAddress='&p1_B.Delayfunction_o1';
bio(212).ndims=2;
bio(212).size=[];


bio(213).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/GPS Pre-Processing/Delay function/p2';
bio(213).sigName='';
bio(213).portIdx=1;
bio(213).dim=[1,1];
bio(213).sigWidth=1;
bio(213).sigAddress='&p1_B.Delayfunction_o2';
bio(213).ndims=2;
bio(213).size=[];


bio(214).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/GPS Pre-Processing/Sum1';
bio(214).sigName='';
bio(214).portIdx=0;
bio(214).dim=[1,1];
bio(214).sigWidth=1;
bio(214).sigAddress='&p1_B.Sum1_b';
bio(214).ndims=2;
bio(214).size=[];


bio(215).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/GPS Pre-Processing/Switch2';
bio(215).sigName='';
bio(215).portIdx=0;
bio(215).dim=[1,1];
bio(215).sigWidth=1;
bio(215).sigAddress='&p1_B.Switch2';
bio(215).ndims=2;
bio(215).size=[];


bio(216).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/GPS Pre-Processing/Switch3.5';
bio(216).sigName='';
bio(216).portIdx=0;
bio(216).dim=[1,1];
bio(216).sigWidth=1;
bio(216).sigAddress='&p1_B.Switch35';
bio(216).ndims=2;
bio(216).size=[];


bio(217).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/Roll//Yaw Gyro Pre-processing/cross coupling from roll';
bio(217).sigName='';
bio(217).portIdx=0;
bio(217).dim=[1,1];
bio(217).sigWidth=1;
bio(217).sigAddress='&p1_B.crosscouplingfromroll';
bio(217).ndims=2;
bio(217).size=[];


bio(218).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/Roll//Yaw Gyro Pre-processing/Sum3';
bio(218).sigName='';
bio(218).portIdx=0;
bio(218).dim=[1,1];
bio(218).sigWidth=1;
bio(218).sigAddress='&p1_B.Sum3';
bio(218).ndims=2;
bio(218).size=[];


bio(219).blkName='Sensor Data and Estimation/Vehicle State Estimator/state estimation/Super Filter/Roll//Yaw Gyro Pre-processing/Sum5';
bio(219).sigName='';
bio(219).portIdx=0;
bio(219).dim=[1,1];
bio(219).sigWidth=1;
bio(219).sigAddress='&p1_B.Sum5';
bio(219).ndims=2;
bio(219).size=[];


bio(220).blkName='User Controllers/Steering Controller/HAL-9000/Double chirp/Chirp One/Gain';
bio(220).sigName='';
bio(220).portIdx=0;
bio(220).dim=[1,1];
bio(220).sigWidth=1;
bio(220).sigAddress='&p1_B.Gain_e';
bio(220).ndims=2;
bio(220).size=[];


bio(221).blkName='User Controllers/Steering Controller/HAL-9000/Double chirp/Chirp Two/Gain';
bio(221).sigName='';
bio(221).portIdx=0;
bio(221).dim=[1,1];
bio(221).sigWidth=1;
bio(221).sigAddress='&p1_B.Gain_c';
bio(221).ndims=2;
bio(221).size=[];


bio(222).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Handwheel Sensor Fault Detection/Fault Detection1/Counter/Relational Operator2';
bio(222).sigName='';
bio(222).portIdx=0;
bio(222).dim=[1,1];
bio(222).sigWidth=1;
bio(222).sigAddress='&p1_B.RelationalOperator2';
bio(222).ndims=2;
bio(222).size=[];


bio(223).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Handwheel Sensor Fault Detection/Fault Detection1/Counter1/Relational Operator2';
bio(223).sigName='';
bio(223).portIdx=0;
bio(223).dim=[1,1];
bio(223).sigWidth=1;
bio(223).sigAddress='&p1_B.RelationalOperator2_i';
bio(223).ndims=2;
bio(223).size=[];


bio(224).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Handwheel Sensor Fault Detection/Fault Detection1/Enabled Subsystem/In1';
bio(224).sigName='';
bio(224).portIdx=0;
bio(224).dim=[1,1];
bio(224).sigWidth=1;
bio(224).sigAddress='&p1_B.EnabledSubsystem_j0.In1';
bio(224).ndims=2;
bio(224).size=[];


bio(225).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Handwheel Sensor Fault Detection/Fault Detection1/Enabled Subsystem1/In1';
bio(225).sigName='';
bio(225).portIdx=0;
bio(225).dim=[1,1];
bio(225).sigWidth=1;
bio(225).sigAddress='&p1_B.EnabledSubsystem1.In1';
bio(225).ndims=2;
bio(225).size=[];


bio(226).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Handwheel Sensor Fault Detection/Fault Detection1/Nearly the Same/Relational Operator';
bio(226).sigName='';
bio(226).portIdx=0;
bio(226).dim=[1,1];
bio(226).sigWidth=1;
bio(226).sigAddress='&p1_B.RelationalOperator_g';
bio(226).ndims=2;
bio(226).size=[];


bio(227).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Handwheel Sensor Fault Detection/Fault Detection1/Nearly the Same2/Relational Operator';
bio(227).sigName='';
bio(227).portIdx=0;
bio(227).dim=[1,1];
bio(227).sigWidth=1;
bio(227).sigAddress='&p1_B.RelationalOperator_l';
bio(227).ndims=2;
bio(227).size=[];


bio(228).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Handwheel Sensor Fault Detection/Descision Logic/Latch/Enabled Subsystem/In1';
bio(228).sigName='';
bio(228).portIdx=0;
bio(228).dim=[1,1];
bio(228).sigWidth=1;
bio(228).sigAddress='&p1_B.EnabledSubsystem.In1';
bio(228).ndims=2;
bio(228).size=[];


bio(229).blkName='Hardware I//O/Input/Handwheel Scaling & Initialization/Handwheel Sensor Fault Detection/Descision Logic/Latch1/Enabled Subsystem/In1';
bio(229).sigName='';
bio(229).portIdx=0;
bio(229).dim=[1,1];
bio(229).sigWidth=1;
bio(229).sigAddress='&p1_B.EnabledSubsystem_j.In1';
bio(229).ndims=2;
bio(229).size=[];

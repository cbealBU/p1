...
bio(11).blkName='Hardware I//O/Input/Hemisphere VS330/p1';
bio(11).sigName='';
bio(11).portIdx=0;
bio(11).dim=[24,1];
bio(11).sigWidth=24;
bio(11).sigAddress='&p1_B.HemisphereVS330_o1[0]';
bio(11).ndims=2;
bio(11).size=[];


bio(12).blkName='Hardware I//O/Input/Hemisphere VS330/p2';
bio(12).sigName='';
bio(12).portIdx=1;
bio(12).dim=[1,1];
bio(12).sigWidth=1;
bio(12).sigAddress='&p1_B.HemisphereVS330_o2';
bio(12).ndims=2;
bio(12).size=[];


bio(13).blkName='Hardware I//O/Input/Ruby-MM/p1';
bio(13).sigName='Fault Switch';
bio(13).portIdx=0;
bio(13).dim=[1,1];
bio(13).sigWidth=1;
bio(13).sigAddress='&p1_B.FaultSwitch';
bio(13).ndims=2;
bio(13).size=[];


bio(14).blkName='Hardware I//O/Input/Ruby-MM/p2';
bio(14).sigName='Auto-Steer Switch';
bio(14).portIdx=1;
bio(14).dim=[1,1];
bio(14).sigWidth=1;
bio(14).sigAddress='&p1_B.AutoSteerSwitch';
bio(14).ndims=2;
bio(14).size=[];


bio(15).blkName='Hardware I//O/Input/Ruby-MM/p3';
bio(15).sigName='';
bio(15).portIdx=2;
bio(15).dim=[1,1];
bio(15).sigWidth=1;
bio(15).sigAddress='&p1_B.RubyMM_o3';
bio(15).ndims=2;
bio(15).size=[];


bio(16).blkName='Hardware I//O/Input/Ruby-MM/p4';
bio(16).sigName='';
bio(16).portIdx=3;
bio(16).dim=[1,1];
bio(16).sigWidth=1;
bio(16).sigAddress='&p1_B.RubyMM_o4';
bio(16).ndims=2;
bio(16).size=[];


bio(17).blkName='Hardware I//O/Input/Wheelspeed Sensors';
bio(17).sigName='Front Wheel Speeds';
bio(17).portIdx=0;
bio(17).dim=[2,1];
bio(17).sigWidth=2;
bio(17).sigAddress='&p1_B.FrontWheelSpeeds[0]';
bio(17).ndims=2;
bio(17).size=[];


bio(18).blkName='Hardware I//O/Output/amps to volts';
bio(18).sigName='';
bio(18).portIdx=0;
bio(18).dim=[1,1];
bio(18).sigWidth=1;
bio(18).sigAddress='&p1_ConstB.ampstovolts';
bio(18).ndims=2;
bio(18).size=[];


bio(19).blkName='Hardware I//O/Output/voltage gain';
bio(19).sigName='';
bio(19).portIdx=0;
bio(19).dim=[2,1];
bio(19).sigWidth=2;
bio(19).sigAddress='&p1_B.voltagegain[0]';
bio(19).ndims=2;
bio(19).size=[];


bio(20).blkName='Hardware I//O/Output/saturation';
bio(20).sigName='';
bio(20).portIdx=0;
bio(20).dim=[1,1];
bio(20).sigWidth=1;
bio(20).sigAddress='&p1_B.saturation';
bio(20).ndims=2;
bio(20).size=[];


bio(21).blkName='Hardware I//O/Output/saturation 2';
bio(21).sigName='';
bio(21).portIdx=0;
bio(21).dim=[2,1];
bio(21).sigWidth=2;
bio(21).sigAddress='&p1_B.saturation2[0]';
bio(21).ndims=2;
bio(21).size=[];


bio(22).blkName='Sensor Data and Estimation/Nonlinear Observer/1//Fnf';
bio(22).sigName='muhat';
bio(22).portIdx=0;
bio(22).dim=[1,1];
bio(22).sigWidth=1;
bio(22).sigAddress='&p1_B.muhat';
bio(22).ndims=2;
bio(22).size=[];


bio(23).blkName='Sensor Data and Estimation/Nonlinear Observer/If_alpha_observer/p1';
bio(23).sigName='ahats';
bio(23).portIdx=0;
bio(23).dim=[2,1];
bio(23).sigWidth=2;
bio(23).sigAddress='&p1_B.ahats[0]';
bio(23).ndims=2;
bio(23).size=[];


bio(24).blkName='Sensor Data and Estimation/Nonlinear Observer/If_alpha_observer/p2';
bio(24).sigName='peakFyf';
bio(24).portIdx=1;
bio(24).dim=[1,1];
bio(24).sigWidth=1;
bio(24).sigAddress='&p1_B.peakFyf';
bio(24).ndims=2;
bio(24).size=[];


bio(25).blkName='Sensor Data and Estimation/Nonlinear Observer/If_alpha_observer/p3';
bio(25).sigName='estimation_flags';
bio(25).portIdx=2;
bio(25).dim=[5,1];
bio(25).sigWidth=5;
bio(25).sigAddress='&p1_B.estimation_flags[0]';
bio(25).ndims=2;
bio(25).size=[];


bio(26).blkName='Sensor Data and Estimation/Nonlinear Observer/If_alpha_observer/p4';
bio(26).sigName='pneumatic_trail';
bio(26).portIdx=3;
bio(26).dim=[2,1];
bio(26).sigWidth=2;
bio(26).sigAddress='&p1_B.pneumatic_trail[0]';
bio(26).ndims=2;
bio(26).size=[];


bio(27).blkName='Sensor Data and Estimation/Nonlinear Observer/If_alpha_observer/p5';
bio(27).sigName='peak_forces';
bio(27).portIdx=4;
bio(27).dim=[2,1];
bio(27).sigWidth=2;
bio(27).sigAddress='&p1_B.peak_forces[0]';
bio(27).ndims=2;
bio(27).size=[];


bio(28).blkName='Sensor Data and Estimation/Steering Kinematics/Composite Steer Angle Calculation';
bio(28).sigName='Composite Steer Angle';
bio(28).portIdx=0;
bio(28).dim=[1,1];
bio(28).sigWidth=1;
bio(28).sigAddress='&p1_B.CompositeSteerAngle';
bio(28).ndims=2;
bio(28).size=[];


bio(29).blkName='Sensor Data and Estimation/Vehicle State Estimator/Gain1';
bio(29).sigName='Speed';
bio(29).portIdx=0;
bio(29).dim=[1,1];
bio(29).sigWidth=1;
bio(29).sigAddress='&p1_B.Speed';
bio(29).ndims=2;
bio(29).size=[];


bio(30).blkName='Sensor Data and Estimation/Vehicle State Estimator/Gain2';
bio(30).sigName='';
bio(30).portIdx=0;
bio(30).dim=[1,1];
bio(30).sigWidth=1;
bio(30).sigAddress='&p1_B.Gain2';
bio(30).ndims=2;
bio(30).size=[];


bio(31).blkName='Sensor Data and Estimation/Vehicle State Estimator/Gain3';
bio(31).sigName='Speed';
bio(31).portIdx=0;
bio(31).dim=[1,1];
bio(31).sigWidth=1;
bio(31).sigAddress='&p1_B.Speed_b';
bio(31).ndims=2;
bio(31).size=[];


bio(32).blkName='Sensor Data and Estimation/Vehicle State Estimator/Gain4';
bio(32).sigName='';
bio(32).portIdx=0;
bio(32).dim=[1,1];
bio(32).sigWidth=1;
bio(32).sigAddress='&p1_B.Gain4';
bio(32).ndims=2;
bio(32).size=[];


bio(33).blkName='Sensor Data and Estimation/Vehicle State Estimator/Gain5';
bio(33).sigName='';
bio(33).portIdx=0;
bio(33).dim=[1,1];
bio(33).sigWidth=1;
bio(33).sigAddress='&p1_B.Gain5';
bio(33).ndims=2;
bio(33).size=[];


bio(34).blkName='Sensor Data and Estimation/Vehicle State Estimator/Low-pass filter';
bio(34).sigName='Front Left';
bio(34).portIdx=0;
bio(34).dim=[1,1];
bio(34).sigWidth=1;
bio(34).sigAddress='&p1_B.FrontLeft';
bio(34).ndims=2;
bio(34).size=[];


bio(35).blkName='Sensor Data and Estimation/Vehicle State Estimator/Low-pass filter1';
bio(35).sigName='Horiz Speed';
bio(35).portIdx=0;
bio(35).dim=[1,1];
bio(35).sigWidth=1;
bio(35).sigAddress='&p1_B.HorizSpeed';
bio(35).ndims=2;
bio(35).size=[];


bio(36).blkName='Sensor Data and Estimation/Vehicle State Estimator/Low-pass filter2';
bio(36).sigName='Front Right';
bio(36).portIdx=0;
bio(36).dim=[1,1];
bio(36).sigWidth=1;
bio(36).sigAddress='&p1_B.FrontRight';
bio(36).ndims=2;
bio(36).size=[];


bio(37).blkName='Sensor Data and Estimation/Vehicle State Estimator/Low-pass filter3';
bio(37).sigName='Rear Left';
bio(37).portIdx=0;
bio(37).dim=[1,1];
bio(37).sigWidth=1;
bio(37).sigAddress='&p1_B.RearLeft';
bio(37).ndims=2;
bio(37).size=[];


bio(38).blkName='Sensor Data and Estimation/Vehicle State Estimator/Low-pass filter4';
bio(38).sigName='Rear Right';
bio(38).portIdx=0;
bio(38).dim=[1,1];
bio(38).sigWidth=1;
bio(38).sigAddress='&p1_B.RearRight';
bio(38).ndims=2;
bio(38).size=[];


bio(39).blkName='User Controllers/Cruise Control/Sum1';
bio(39).sigName='';
bio(39).portIdx=0;
bio(39).dim=[1,1];
bio(39).sigWidth=1;
bio(39).sigAddress='&p1_B.Sum1_i';
bio(39).ndims=2;
bio(39).size=[];


bio(40).blkName='User Controllers/Cruise Control/Switch';
bio(40).sigName='';
bio(40).portIdx=0;
bio(40).dim=[1,1];
bio(40).sigWidth=1;
bio(40).sigAddress='&p1_B.Switch_o';
bio(40).ndims=2;
bio(40).size=[];


bio(41).blkName='User Controllers/Steering Controller/Sum';
bio(41).sigName='';
bio(41).portIdx=0;
bio(41).dim=[1,1];
bio(41).sigWidth=1;
bio(41).sigAddress='&p1_B.Sum_gj';
bio(41).ndims=2;
bio(41).size=[];


bio(42).blkName='User Controllers/Steering Controller/Heavy Filter';
bio(42).sigName='';
bio(42).portIdx=0;
bio(42).dim=[1,1];
bio(42).sigWidth=1;
bio(42).sigAddress='&p1_B.HeavyFilter';
bio(42).ndims=2;
bio(42).size=[];


bio(43).blkName='User Controllers/Steering Controller/Nominal Filter';
bio(43).sigName='';
bio(43).portIdx=0;
bio(43).dim=[1,1];
bio(43).sigWidth=1;
bio(43).sigAddress='&p1_B.NominalFilter';
bio(43).ndims=2;
bio(43).size=[];


bio(44).blkName='Controllers and Output/Steering Controller/LF steering controller/Convert to output shaft angle';
bio(44).sigName='';
bio(44).portIdx=0;
bio(44).dim=[1,1];
bio(44).sigWidth=1;
bio(44).sigAddress='&p1_B.Converttooutputshaftangle';
bio(44).ndims=2;
bio(44).size=[];


bio(45).blkName='Controllers and Output/Steering Controller/LF steering controller/Convert to output shaft angle (too)';
bio(45).sigName='';
bio(45).portIdx=0;
bio(45).dim=[1,1];
bio(45).sigWidth=1;
bio(45).sigAddress='&p1_B.Converttooutputshaftangletoo';
bio(45).ndims=2;
bio(45).size=[];


bio(46).blkName='Controllers and Output/Steering Controller/LF steering controller/Kd';
bio(46).sigName='';
bio(46).portIdx=0;
bio(46).dim=[1,1];
bio(46).sigWidth=1;
bio(46).sigAddress='&p1_B.Kd';
bio(46).ndims=2;
bio(46).size=[];


bio(47).blkName='Controllers and Output/Steering Controller/LF steering controller/Ki';
bio(47).sigName='';
bio(47).portIdx=0;
bio(47).dim=[1,1];
bio(47).sigWidth=1;
bio(47).sigAddress='&p1_B.Ki';
bio(47).ndims=2;
bio(47).size=[];


bio(48).blkName='Controllers and Output/Steering Controller/LF steering controller/Sum1';
bio(48).sigName='';
bio(48).portIdx=0;
bio(48).dim=[1,1];
bio(48).sigWidth=1;
bio(48).sigAddress='&p1_B.Sum1_l';
bio(48).ndims=2;
bio(48).size=[];


bio(49).blkName='Controllers and Output/Steering Controller/LF steering controller/Sum2';
bio(49).sigName='';
bio(49).portIdx=0;
bio(49).dim=[1,1];
bio(49).sigWidth=1;
bio(49).sigAddress='&p1_B.Sum2_l';
bio(49).ndims=2;
bio(49).size=[];


bio(50).blkName='Controllers and Output/Steering Controller/LF steering controller/Derivative & Low-pass filter 2';
bio(50).sigName='';
bio(50).portIdx=0;
bio(50).dim=[1,1];
bio(50).sigWidth=1;
bio(50).sigAddress='&p1_B.DerivativeLowpassfilter2';
bio(50).ndims=2;
bio(50).size=[];


bio(51).blkName='Controllers and Output/Steering Controller/RF steering controller/Convert to output shaft angle';
bio(51).sigName='';
bio(51).portIdx=0;
bio(51).dim=[1,1];
bio(51).sigWidth=1;
bio(51).sigAddress='&p1_B.Converttooutputshaftangle_n';
bio(51).ndims=2;
bio(51).size=[];


bio(52).blkName='Controllers and Output/Steering Controller/RF steering controller/Convert to output shaft angle (too)';
bio(52).sigName='';
bio(52).portIdx=0;
bio(52).dim=[1,1];
bio(52).sigWidth=1;
bio(52).sigAddress='&p1_B.Converttooutputshaftangletoo_e';
bio(52).ndims=2;
bio(52).size=[];


bio(53).blkName='Controllers and Output/Steering Controller/RF steering controller/Kd';
bio(53).sigName='';
bio(53).portIdx=0;
bio(53).dim=[1,1];
bio(53).sigWidth=1;
bio(53).sigAddress='&p1_B.Kd_j';
bio(53).ndims=2;
bio(53).size=[];


bio(54).blkName='Controllers and Output/Steering Controller/RF steering controller/Ki';
bio(54).sigName='';
bio(54).portIdx=0;
bio(54).dim=[1,1];
bio(54).sigWidth=1;
bio(54).sigAddress='&p1_B.Ki_o';
bio(54).ndims=2;
bio(54).size=[];


bio(55).blkName='Controllers and Output/Steering Controller/RF steering controller/Sum1';
bio(55).sigName='';
bio(55).portIdx=0;
bio(55).dim=[1,1];
bio(55).sigWidth=1;
bio(55).sigAddress='&p1_B.Sum1_f';
bio(55).ndims=2;
bio(55).size=[];


bio(56).blkName='Controllers and Output/Steering Controller/RF steering controller/Sum2';
bio(56).sigName='';
bio(56).portIdx=0;
bio(56).dim=[1,1];
bio(56).sigWidth=1;
bio(56).sigAddress='&p1_B.Sum2_o';
bio(56).ndims=2;
bio(56).size=[];


bio(57).blkName='Controllers and Output/Steering Controller/RF steering controller/Derivative & Low-pass filter 2';
bio(57).sigName='';
bio(57).portIdx=0;
bio(57).dim=[1,1];
bio(57).sigWidth=1;
bio(57).sigAddress='&p1_B.DerivativeLowpassfilter2_d';
bio(57).ndims=2;
bio(57).size=[];

...
#define S_FUNCTION_NAME Brush_obs
...
extern void Brush_Outputs_wrapper(const real_T *sigma,
                          const real_T *muFz,
                          const real_T *alpha,
                          real_T *Fx,
                          real_T *Fy,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T   *muFz  = (const real_T*) ssGetInputPortSignal(S,1);

...
PreAcce = LQACC_Debug(start:finish,1);
PreSpeed = LQACC_Debug(start:finish,2);
epsilon = LQACC_Debug(start:finish,3); 
DesDist = LQACC_Debug(start:finish,4);
ActDist = LQACC_Debug(start:finish,5);
DesAcce = LQACC_Debug(start:finish,6);
PackVoltages = LQACC_Debug(start:finish,7);
distErr = LQACC_Debug(start:finish,8);
relVel = LQACC_Debug(start:finish,9);
vehACCE = LQACC_Debug(start:finish,10);

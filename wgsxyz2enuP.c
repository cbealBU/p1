 ...
 * File : wgsxyz2enu.c
 *
 *	[east, north, up]=wgsxyz2enuP(x,y,z,refx,refy,refz)
 *
 * Abstract:
 *	Transforms x y z representing a point in WGS84 xyz coordinates
 * into its corresponding east north and up coordinates,
 * referenced to location refx, refy, refz
 *
 *
 *
 */
...
#define S_FUNCTION_NAME  wgsxyz2enuP

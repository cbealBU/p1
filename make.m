...
srcnames={'beeline.c','bic_model.c', 'bike_model_threestate.c','ckf.c','enable.c','rlsfilt.c',...
	      'nameddemux.c','namedmux.c','rs232_OEM4_MultiMode.c','ssest_filter.c',...
          'UltimateEncoder.c','wgsxyz2enuP.c','wgsxyz2enuV.c',...
		  'vcmdasad.c','vsbc6ad.c','friction_observer_beal.c'...
		  'vsbc8led.c','wheelspeed.c','handwheel.c','encoderinit.c','unwrapper.c',...
          'rollfilter.c','hdgfilter_s.c','velfilter_acc.c','utcchangebeeline.c',...
          'utcchangemillennium.c','ppsbeeline.c','ppsmillennium2.c',...
          'If_alpha_observer.c','lat_err_yaw4_switch.c','lat_err_yaw4_switch_map2.c',...
          'lat_err_yaw4_switch_map2Judy.c','pos_filter2.c', 'calculate_lookahead.c'...
          ...
          'holdingSteering.c', 'ssc_safe_area.c', 'drift_controller_DSC.c', 'Brush.c',...
          'Brush_obs.c', 'TECslipcont.c', 'VEC.c', 'estimate_aligningTorque.c', 'c_sfun_mpcacc.c',...
          'driftkeeping.c', 'drift_speed_controller.c', 'drift_controller_SDSC.c', 'match_scacs2.c',...
          'stateprediction.c', 'inbounds_control.c', 'lat_err_yaw4_switch_KT.c', 'drift_controller_SSC.c', 'asciiStreamtoString.c','rs232_stream_rcv.c'};
